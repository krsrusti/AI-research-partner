import { n as __exportAll, t as __commonJSMin } from "./rolldown-runtime-B-1-B7_t.js";
...
var test$2$1 = (val) => val && (val[IS_ITERABLE_SENTINEL] === true || val[IS_RECORD_SENTINEL] === true);
var plugin$2 = {
...
var serialize$1$1 = (element, config, indentation, depth, refs, printer) => ++depth > config.maxDepth ? printElementAsLeaf(getType$2(element), config) : printElement(getType$2(element), printProps(getPropKeys$1(element), element.props, config, indentation + config.indent, depth, refs, printer), printChildren(getChildren(element.props.children), config, indentation + config.indent, depth, refs, printer), config, indentation);
var test$1$1 = (val) => val != null && ReactIs.isElement(val);
var plugin$1 = {
...
var serialize$6 = (object, config, indentation, depth, refs, printer) => ++depth > config.maxDepth ? printElementAsLeaf(object.type, config) : printElement(object.type, object.props ? printProps(getPropKeys(object), object.props, config, indentation + config.indent, depth, refs, printer) : "", object.children ? printChildren(object.children, config, indentation + config.indent, depth, refs, printer) : "", config, indentation);
var test$6 = (val) => val && val.$$typeof === testSymbol;
var plugin$6 = {
...
var stringEscapeChars$1 = /* @__PURE__ */ new RegExp("['\\u0000-\\u001f\\u007f-\\u009f\\u00ad\\u0600-\\u0604\\u070f\\u17b4\\u17b5\\u200c-\\u200f\\u2028-\\u202f\\u2060-\\u206f\\ufeff\\ufff0-\\uffff]", "g");
...
var chaiInspect$1 = typeof Symbol === "function" && typeof Symbol.for === "function" ? Symbol.for("chai/inspect") : "@@chai/inspect";
var nodeInspect$1 = Symbol.for("nodejs.util.inspect.custom");
var constructorMap$1 = /* @__PURE__ */ new WeakMap();
var stringTagMap$1 = {};
var baseTypesMap$1 = {
...
var inspectCustom$1 = (value, options, type, inspectFn) => {
...
var { AsymmetricMatcher: AsymmetricMatcher$3, DOMCollection: DOMCollection$2, DOMElement: DOMElement$2, Immutable: Immutable$2, ReactElement: ReactElement$2, ReactTestComponent: ReactTestComponent$2 } = plugins;
var PLUGINS$2 = [
...
var { AsymmetricMatcher: AsymmetricMatcher$2, DOMCollection: DOMCollection$1, DOMElement: DOMElement$1, Immutable: Immutable$1, ReactElement: ReactElement$1, ReactTestComponent: ReactTestComponent$1 } = plugins;
var PLUGINS$1 = [
...
var _IS_ABSOLUTE_RE$2 = /^[/\\](?![/\\])|^[/\\]{2}(?!\.)|^[A-Za-z]:[/\\]/;
function cwd$2() {
...
var resolve$1 = function(...arguments_) {
...
var isAbsolute$1 = function(p) {
	return _IS_ABSOLUTE_RE$1.test(p);
};
var dirname$1 = function(p) {
...
* ```
*/
var onTestFailed = createTestHook("onTestFailed", (test, handler, timeout) => {
	test.onFailed ||= [];
...
* ```
*/
var onTestFinished = createTestHook("onTestFinished", (test, handler, timeout) => {
	test.onFinished ||= [];
...
var { clearTimeout: clearTimeout$1, setTimeout: setTimeout$1 } = getSafeTimers();
...
var test$1 = (val) => val && !!val._isMockFunction;
var plugin = {
...
async function saveInlineSnapshots(environment, snapshots) {
	const MagicString = (await import("./magic-string.es-BlqeY5Fk.js")).default;
...
var benchmarkTasks = /* @__PURE__ */ new WeakMap();
...
var NodeBenchmarkRunner = class {
	...
	async importTinybench() {
		return await import("./dist-CwAg7a5o.js");
	}
...
//#endregion
//#region node_modules/vitest/dist/chunks/index.DdgEv5B1.js
